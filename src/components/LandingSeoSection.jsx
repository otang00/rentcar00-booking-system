const seoItems = [
  ...
  {
    title: '단기렌트와 1주일렌트 상담',
    description: '하루 단위 단기렌트부터 1주일렌트까지 일정에 맞는 차량 조건을 확인할 수 있습니다. 필요한 기간과 운전자 조건에 맞춰 예약 흐름을 단순하게 구성했습니다.',
  },
  {
    title: '사고대차·일반렌트 문의',
    ...
    <section className="landing-seo-section" aria-labelledby="landing-seo-title">
      <div className="container landing-seo-container">
        <div className="landing-seo-head">
          ...
          <h2 id="landing-seo-title">딜리버리 렌터카, 단기렌트, 1주일렌트까지 한 번에 확인하세요</h2>
          <p>
            빵빵카는 서울·수도권 렌터카 예약을 더 쉽게 확인할 수 있도록 위치, 대여 시간,
            반납 시간을 먼저 선택하는 방식으로 운영합니다. 서초 렌트카 상담, 사고대차,
            일반렌트 문의도 함께 안내합니다.
          </p>
        </div>
