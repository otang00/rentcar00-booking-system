        ...
        <div className="landing-v2-guide-steps">
          <article>
            ...
            <div>
              ...
              <p>차량을 받을 지역을 먼저 선택합니다.</p>
            </div>
          </article>
          <article>
            <b>02</b>
            <div>
              <strong>대여·반납 일정 선택</strong>
              <p>예약 가능한 시간 기준에 맞춰 일정을 선택합니다.</p>
            </div>
          </article>
          <article>
            <b>03</b>
            <div>
              <strong>차량 검색 후 결제</strong>
              <p>예약 가능한 차량과 금액을 확인한 뒤 결제를 진행합니다.</p>
            </div>
          </article>
          <article>
            <b>04</b>
  ...
  return (
    <section className="landing-v2-fixed-hero" aria-label="빵빵카 렌터카 안내">
      ...
      <div className="landing-v2-fixed-hero__content">
        ...
        <h1>원하는 시간,<br />원하는 장소에서<br />바로 예약</h1>
